...
class StatesControllerTest < ActionController::TestCase
  ...
  test "should create state" do
    assert_difference('State.count') do
      post :create, state: { capitol: @state.capitol, name: @state.name, population: @state.population, stateAnimal: @state.stateAnimal }
    end
  ...
  test "should update state" do
    patch :update, id: @state, state: { capitol: @state.capitol, name: @state.name, population: @state.population, stateAnimal: @state.stateAnimal }
    assert_redirected_to state_path(assigns(:state))
  end
